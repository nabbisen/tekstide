...
| 023 | [Configuration System](./accepted/023-configuration-system.md) | **Accepted 2026-08-18.** Owns `set_resource_limits` (the reachability audit's priority 3), the per-role theme values `Theme` is a seam for, and the decision recorded in its own pack that the WCAG contrast gate does not survive configurability |
