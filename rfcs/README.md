...
| — | [Safe-close confirmation honesty](./handoffs/safe-close-confirmation-honesty.md) — no RFC; **M12, second of three**. `fully_confirmed: true` can reach the durable audit store while a process the terminal launched keeps running |
