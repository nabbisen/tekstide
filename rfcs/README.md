...
| RFC | Title | Status |
| --- | --- | --- |
| 020 | [Diff Review and AgentRun Report Surfaces](./proposed/020-diff-review-and-agentrun-report.md) | Proposed 2026-08-11 — M10 second half; **blocked on two model amendments**, see the RFC |
