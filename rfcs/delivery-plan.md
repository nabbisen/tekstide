...
| 034 | Change Review Actions and Review State | M12 | 020, 012, 042 | no | **Unblocked 2026-08-26** by RFC-042. **Accepted 2026-08-18; unblocked 2026-08-25; amended 2026-08-26.** Second of three for `0.15.0`. The amendment records that neither value this RFC was accepted for exists today — no audit family covers a user's opinion of generated code, and `ChangeSet` has no `Serialize`, so a decision dies with the process. D0/D1/D2/D3 all decided on scheduling: session-scoped and said so; `Accepted`/`Rejected` only; no audit record; a stale tree is disclosed, not blocking. **Added to this queue retroactively 2026-08-25**, having been accepted for a week without appearing here **Pack written 2026-08-26**, with a fifth decision D4: the controls are one-way, so finality is stated before the click |
