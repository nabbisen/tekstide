...
| 043 | Terminal Process Containment | M12 | 008, 009, 013 | **yes** | **Proposed 2026-08-26.** Termination signals one process group; an interactive shell's `&` jobs each get their own, inside its session — measured on 2,115 orphans, and the previously recorded cause refuted. D1 is the product question deferred since 2026-08-25: kill a backgrounded job on close, or leave it? Today it is neither. D3 touches the safe-close audit field renamed in request 328 precisely because it could not see these processes |
