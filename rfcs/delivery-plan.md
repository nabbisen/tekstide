...
| 034 | Change Review Actions and Review State | M12 | 020, 012 | no | **Accepted 2026-08-18; unblocked 2026-08-25** by RFC-020's change review surface. Acts on **metadata only** until RFC-041 lands — an action defined here would be taken on what the surface shows, not on inspected content. **Added to this queue retroactively 2026-08-25**, having been accepted for a week without appearing here |
...
| 041 | Change Content Preview | M12 | 024, 020 | no | **Accepted 2026-08-25, third of three for `0.14.0`.** RFC-024 built and gated content access in `0.7.0`; it has zero production callers because `add_detected_generated_change_set` discards the `DetectedChanges` it needs. Content preview, not a diff — the two-sided case is blocked on RFC-030, not cancelled |
