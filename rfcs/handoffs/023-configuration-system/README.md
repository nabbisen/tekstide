...
Source RFC: [RFC-023](../../done/023-configuration-system.md)
...
| # | Document | Purpose |
| --- | --- | --- |
| 1 | [RFC-023](../../done/023-configuration-system.md) | Format, precedence, atomic validation, security-sensitive settings, audit vocabulary. |
