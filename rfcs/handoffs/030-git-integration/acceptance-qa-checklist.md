...
- [x] Commits are pushed once the gate is green.
      — `c98317e` (the review-415 symlink fix, this response), on top of `541da29` (PR-030-D),
      `2e79eb3` (explorer wiring), `75f5c99`/`e8339db` (computation layer, review-413 checklist
      scaffolding).
