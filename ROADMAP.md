...
| M12 | `0.13.0`–`0.25.0` (**complete 2026-09-24**) | Configuration And Integrations | Configuration system, keybindings/theme/profiles, Git integration, notifications. **All delivered.** The configuration mechanism (RFC-023/045), Git integration (RFC-030), notifications (RFC-025), thirteen interaction/audit RFCs (039–051), and — closing the milestone — **RFC-054**, which made keybindings, theme, fonts and terminal scrollback user configuration. |
